...
const bool DISABLE_Z = false; //false; //true;
...
const int X_MAX_LENGTH = 23; //200; //
const int Y_MAX_LENGTH = 12; //200;
const int Z_MAX_LENGTH = 20;
...
float max_start_speed_units_per_second[] = {5.0,5.0,0.2,10.0};  //  //10 for mosaic? // 25.0 originally
