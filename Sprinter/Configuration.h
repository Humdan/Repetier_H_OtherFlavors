...
#define _AXIS_STEP_PER_UNIT {5, 5.0525, 500,35.0}
...
//-----------------------------------------------------------------------
const int X_MAX_LENGTH = 250;
const int Y_MAX_LENGTH = 220;
const int Z_MAX_LENGTH = 350;

//-----------------------------------------------------------------------
//// MOVEMENT SETTINGS
//-----------------------------------------------------------------------
const int NUM_AXIS = 4; // The axis order in all axis related arrays is X, Y, Z, E
#define _MAX_FEEDRATE {80, 80, 2.25, 5}       // (mm/sec) 
#define _HOMING_FEEDRATE {5000,5000,150}      // (mm/min) !!
...
#define _MAX_XY_JERK .2
#define _MAX_Z_JERK 0.8
#define _MAX_E_JERK .0    // (mm/sec)
//#define _MAX_START_SPEED_UNITS_PER_SECOND {25.0,25.0,0.2,10.0}
#define _MAX_ACCELERATION_UNITS_PER_SQ_SECOND {5000,5000,500,500}    // X, Y, Z and E max acceleration in mm/s^2 for printing moves or retracts
